      ...
      <main className={styles.main}>
        <section className='jumbotron rounded-lg bg-[url("../public/assets/img/net.jpg")] bg-no-repeat bg-cover bg-center mb-5 top-0 left-0 laptop:w-full laptop:h-96 tablet:w-full tablet:h-72 hp:w-full hp:h-40 relative'>
          ...
          <div className="inset-x-0 bottom-1/4 absolute">
            <h1 className='text-lg font-bold z-20 text-center text-amber-300 drop-shadow-md hover:drop-shadow-xl'>Zalira Edu Tech</h1>
          </div>
        </section>
        <section id='about' className='problem h-auto text-center card bg-slate-400 w-full p-10 mb-3'>
          <h1 className='text-amber-300 laptop:text-6xl hp:text-2xl font-poppins drop-shadow-md hover:drop-shadow-xl'>Our Vision</h1>
          <h4 className='laptop:text-lg hp:text-sm'>&quot;We facilitate you according to your needs&quot; </h4>
        </section>
          ...
          <div id="projects" className="animate-marquee2 ">
            <div className="inline-flex p-10">
              <div className="card product laptop:w-60 hp:w-40 laptop:h-96 hp:h-72 m-5 text-center p-4">
                ...
                <button className='bg-slate-700 rounded-xl p-1 w-full text-amber-300'><a href="s.id/cerminmuslim" target={"_blank"} rel={"noreferrer"} />Link</button>
                <p className='laptop:text-sm hp:text-xs'>Ebook apps build in android studio using java lang.</p>
              </div>
              <div className="card product laptop:w-60 hp:w-40 laptop:h-96 hp:h-72 m-5 text-center p-4 ">
                <Image src={beristirahatlah} alt="prod-1" className='w-full laptop:h-52 hp:h-24 mb-4' />
                <h3 className='laptop:text-lg hp:text-sm underline mb-2'>#Beristirahatlah</h3>
                <button className='bg-slate-700 rounded-xl p-1 w-full text-amber-300'><a href="s.id/beristirahatlah" target={"_blank"} rel={"noreferrer"} />Link</button>
              ...
              <div className="card product laptop:w-60 hp:w-40 laptop:h-96 hp:h-72 m-5 text-center p-4 ">
                ...
                <button className='bg-slate-700 rounded-xl p-1 w-full text-amber-300'><a href="https://play.google.com/store/apps/details?id=id.zlz.examforms" target={"_blank"} rel={"noreferrer"}/>Link</button>
                <p className='laptop:text-sm hp:text-xs'>Exam Apps For Google Forms and Microsoft Forms</p>
              </div>
              <div className="card product laptop:w-60 hp:w-40 laptop:h-96 hp:h-72 m-5 text-center p-4 ">
                ...
                <button className='bg-slate-700 rounded-xl p-1 w-full text-amber-300'><a href="https://bukutamu.sman14bdg.sch.id" target={"_blank"} rel={"noreferrer"} />Link</button>
                <p className='laptop:text-sm hp:text-xs'>Guest book Apps build using ReactJs and ExpressJs as Backend and WhatsApp Bot integration</p>
              </div>
            </div>
          </div>
          <div className="absolute top-0 left-20 animate-marquee">
            <div className="inline-flex p-10">
              <div className="card product laptop:w-60 hp:w-40 laptop:h-96 hp:h-72 m-5 text-center p-4 ">
                ...
                <button className='bg-slate-700 rounded-xl p-1 w-full text-amber-300'><a href="https://sukema.mtssnurulhuda.sch.id" target={"_blank"} rel={"noreferrer"} />Link</button>
              ...
              <div className="card product laptop:w-60 hp:w-40 laptop:h-96 hp:h-72 m-5 text-center p-4 ">
                ...
                <button className='bg-slate-700 rounded-xl p-1 w-full text-amber-300'><a href="https://mtssnurulhuda.sch.id" target={"_blank"} rel={"noreferrer"} />Link</button>
        ...
        <section className='card recent-project mb-5'>
          ...
          <div className="flex flex-wrap w-full latest-project">
            <iframe className='laptop:w-full laptop:h-96 hp:w-full hp:h-40 m-5 rounded-2xl' src="https://www.youtube.com/embed/6SBO5hPRLnQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <article className='ml-5 align-middle'>Aplikasi buku tamu yang dilengkapi dengan WhatsApp Gateway/Bot mempermudah validasi dan konfirmasi tamu yang berkunjung. Admin dapat mengecek rekap tamu secara real time.</article>
          </div>
        </section>
        <section id='contact'>
